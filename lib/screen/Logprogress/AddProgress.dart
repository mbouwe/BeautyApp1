...
class CostumerProgress extends StatefulWidget {

  const CostumerProgress({Key? key}) : super(key: key);

  @override
  State<CostumerProgress> createState() => _CostumerProgressState();
}

class _CostumerProgressState extends State<CostumerProgress> with TickerProviderStateMixin {
  ...
  sudmit() async {
    ...
    var res = await CallApi().postData(
        data, 'save_customer_progress/${UserData[0]['id']}');
    ...
    if (body['success'] == 'true') {
      var snackBar = SnackBar(
        ...
        content: AwesomeSnackbarContent(
          title: 'yeah!',
          message: 'Challenge Progress add successfully!!!!',
      ...
      var snackBar = SnackBar(
        ...
        content: AwesomeSnackbarContent(
          title: 'yeah!',
          message: 'Challenge Progress add failed!!!!',
          contentType: ContentType.failure,
        ),
      );
      ScaffoldMessenger.of(context)
